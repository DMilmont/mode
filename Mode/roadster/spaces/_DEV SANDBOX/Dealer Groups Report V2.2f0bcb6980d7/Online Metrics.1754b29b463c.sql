...
COALESCE("In-Store Shares", 0.0) "In-Store Shares", 
...
COALESCE(instore_prospects, 0.0) "In-Store Prospects",
COALESCE("In-Store Orders", 0.0) "In-Store Orders",
COALESCE(online_orders, 0.0) "Online Orders",
