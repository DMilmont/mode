SELECT sum( CASE WHEN "Region"='West' THEN 1
     ...
     ,sum( CASE WHEN "Check-In Status"='Open and Overdue' AND "Region"='West'  THEN 1
       ...
       ,ROUND(100.0 * (
       sum( CASE WHEN "Check-In Status" in ('Currently Open','Completed - On Time') AND "Region"='West' THEN 1.0
       ELSE 0 END)            /
      ...
      ,ROUND(100.0 * (
       sum( CASE WHEN "Check-In Status" in ('Currently Open','Completed - On Time')  AND "Region"='East' THEN 1.0
       ELSE 0 END)            /
